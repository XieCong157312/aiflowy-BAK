 ...
 */
@RestController
@RequestMapping("/public-api/v1/workflowExecStep")
public class PublicWorkflowExecStepController extends BaseCurdController<WorkflowExecStepService, WorkflowExecStep> {

    @Resource
    private WorkflowExecResultService execRecordService;

    public PublicWorkflowExecStepController(WorkflowExecStepService service) {
        super(service);
    }
