 ...
 */
@RestController
@RequestMapping("/public-api/v1/workflowExecResult")
public class PublicWorkflowExecResultController extends BaseCurdController<WorkflowExecResultService, WorkflowExecResult> {

    @Resource
    private WorkflowExecStepService recordStepService;

    public PublicWorkflowExecResultController(WorkflowExecResultService service) {
        super(service);
    }
